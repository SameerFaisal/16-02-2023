...
// $(document).ready(function(){
//     $("button").click(function(){
//       $("#green").animate({fontSize:'150px'},3000);
...
//        $("#output").val("The Result is: "+result)
//     })
// })
